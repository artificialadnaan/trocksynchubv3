...
CMD ["sh", "-c", "npm run db:migrate-reconciliation && npm run db:push && npm run db:migrate-approved-attachments && npm run db:migrate-audit-log-category && npm run db:migrate-rfp-reporting && npm run start"]
