-- Re-apply Bid Board stage mappings with direction-scoped matching.
-- This intentionally touches only bidboard_to_hubspot rows and leaves any reverse/admin mappings alone.
