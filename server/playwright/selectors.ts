...
export const PROCORE_SELECTORS = {
  ...
  bidboard: {
    ...
    newUi: {
      ...
      projectNumberInput: 'input[name="projectNumber"]',
      dueDateInput: 'input[placeholder="MM/DD/YYYY"]',
      addCustomerButton: 'button.aid-add-customer-button',
      addAddressButton: 'button.aid-add-address-button',
      addressStreetInput: 'input[name="street"]',
      addressCityInput: 'input[name="city"]',
      addressStateInput: 'input[name="state"]',
      addressZipInput: 'input[name="zip"]',
      addressCountryInput: 'input[name="country"]',
